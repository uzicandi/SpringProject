									...
									<div class="container">
										<div class="row">
											<div class="col-12">
												...
												<form action="memberJoinForm.do" name="form" method="post">
													<table>
														<tr>
															<td width="100%" height="100%"><span style="padding-left: 160px">
														</tr>
														<tr>
															<td width="100%" height="100%" align="center">
																<p align="left">
																<h3 style="align: center">< BMW 회원가입 약관 ></h3>
																</p> <br> <textarea id="agreeTextBox" rows="100" cols="150">
제 1 장 총 칙

제 1 조 (목적)
이 약관은 BMW(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
[부칙]
(시행일) 이 약관은 2019년 01월부터 시행합니다.
</textarea> <br> <input type="checkbox" name="req"> 개인정보 수집 및 이용에 동의합니다.
															</td>
														</tr>
														<tr>
															<td align="center" valign="top">
															<input type="button" value="거부" onclick="nochk()" />&emsp;
															<input type="button" class="btn bg-maroon" value="동의" onclick="chk()" /> 
															</td>
														</tr>
													</table>
												</form>
