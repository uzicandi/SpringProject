...
public class HWKMemberDao {
	private static HWKMemberDao instance;

	private HWKMemberDao() {
	}

	public static HWKMemberDao getInstance() {
		if (instance == null) {
			System.out.println("HWK멤버다오 인스턴스 호출");
			instance = new HWKMemberDao();
		}
		return instance;
	}
