...
public class SDBReviewListAct implements CommandProcess {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int totCnt = cd.getTotalCnt(id, "ITEMINFO");
			...
			// 초기화시 1 , 10
			List<Comments> list = cd.list(id, startRow, endRow, "ITEMINFO");
			// 페이지수 38 / 10 -> 4
